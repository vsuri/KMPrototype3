...
public class Inventory extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = db.query(DBHelper.TABLE_INV, resultColumns, where, whereArgs, groupBy, having,
                order);
    ...
    public void saveItemDetails(String item_name)
    {
        SQLiteDatabase db = new DBHelper(this).getWritableDatabase();
        ContentValues newValues = new ContentValues();
        newValues.put(DBHelper.ITEM_COLUMN, item_name);
    ...
    protected void removeItemFromList(int position) {
        ...
        AlertDialog.Builder alert = new AlertDialog.Builder(Inventory.this);
        ...
        alert.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                db.delete(DBHelper.TABLE_INV, whereClause, whereArgs);
                Intent intent = getIntent();
                finish();
                startActivity(intent);
